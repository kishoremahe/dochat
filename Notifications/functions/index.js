...
.onWrite((data, context) => 
{
    ...
    admin.database().ref(`/users/${receiver_user_id}/login_status`)
    .once('value',(snap)=>
    {
        const Login_status=snap.val();
        console.log(receiver_user_id," login status = ",Login_status);
        ...
        {
            console.log(receiver_user_id," user logged out !");
        }
                            ...
                            .on('value',(snap)=>
                            {
                                ...
                                if(MsgType == "image")
                                {
                                    ...
                                    DeviceToken1.then(result => 
                                    {
                                        ...
                                        admin.messaging().sendToDevice(token_id1, payload1)
                                        .then(response => 
                                        { 
